(function (svgR) {
    ...
    b.init = function () {
        ...
        b.initDefs();
        b.initShapes();
        b.interval = Math.floor(1E3 / svgR.Fr)
    };
    ...
    b.initRoot = function () {
        ...
        //added to centre image, in the html (googledrive/wad/centreSpriteJs)
        //  it was found that the aspect ratio here was affecting it and the 490 - 417 was not right
        //    b.root.setAttribute("viewBox", "0 0 312 417");
        //    b.root.setAttribute("preserveAspectRatio", "xMinYMin");

        b.root.setAttribute("viewBox", "0 0 490 900");
        b.root.setAttribute("preserveAspectRatio", "xMinYMin");
    ...
    b.initShapes = function () {
        for (var a = svgR.tg, c = 0, f = a.length; c < f; c++) {
            var d = a[c];
            switch (d.tp) {
                case 2:
                    b.processShape(d);
    ...
    b.filterElement = function (a, c) {
        ...
        this.Rgb = function (a) {
            ...
            for (a = 0; a < colors.length; a++) {
                var f = b.createTag("feFunc" + colors[a]);
